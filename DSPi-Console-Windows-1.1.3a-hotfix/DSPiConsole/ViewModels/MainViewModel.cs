...
public partial class MainViewModel : ObservableObject, IDisposable
{
    ...
    // PDM output index (last output channel)
    public int PdmOutputIndex => Platform == "RP2040" ? 4 : 8;

    // No conflict: PDM and SPDIF 2+ can coexist — Core 0 handles all SPDIF EQ
    // in the single-core path while Core 1 runs the PDM sigma-delta loop.
    public bool WouldConflict(int outputIndex) => false;
