...
static void perform_rate_change(uint32_t new_freq) {
    switch (new_freq) { case 44100: case 48000: case 96000: break; default: new_freq = 96000; }
...
void core0_init() {
    ...
    preset_boot_load();
    {
        ...
        dsp_update_delay_samples(96000.0f);
        restore_interrupts(flags);
    ...
    loudness_recompute_table(loudness_ref_spl, loudness_intensity_pct, 96000.0f);
    ...
    leveller_compute_coefficients(&leveller_coeffs, (const LevellerConfig *)&leveller_config, 96000.0f);
