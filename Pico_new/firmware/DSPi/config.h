...
// 17 gives ~1.4s time constant at 96kHz (tau = 2^shift / sample_rate), safe for bass
#define PDM_LEAKAGE_SHIFT 17

// PDM Soft Start/Stop
#define PDM_FADE_IN_SHIFT   11                        // 2^11 = 2048 samples
#define PDM_FADE_IN_SAMPLES (1u << PDM_FADE_IN_SHIFT) // ~21ms at 96kHz
...
// DELAY CONFIGURATION
#if PICO_RP2350
#define MAX_DELAY_SAMPLES 4096   // ~42ms at 96kHz
#else
#define MAX_DELAY_SAMPLES 2048   // ~21ms at 96kHz
#endif
